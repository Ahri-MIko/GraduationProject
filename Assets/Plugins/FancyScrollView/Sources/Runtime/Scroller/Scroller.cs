...
namespace FancyScrollView
{
    ...
    public class Scroller : UIBehaviour, IPointerUpHandler, IPointerDownHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler
    {
        ...
        /// <summary>
        /// <see cref="ViewportSize"/> 从一端到另一端进行拖动时滚动位置的变化量。
        /// </summary>
        ...
        /// <summary>
        /// 是否使用惯性。 <c>true</c> を指定すると慣性が有効に, <c>false</c> を指定すると慣性が無効になります.
        /// </summary>
        public bool Inertia
        {
            get => inertia;
        ...
        /// <summary>
        /// 滚动的减速率。 <see cref="Inertia"/> が <c>true</c> の場合のみ有効です.
        /// </summary>
