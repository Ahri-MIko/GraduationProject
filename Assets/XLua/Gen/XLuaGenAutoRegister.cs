...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(Kirara.KiraraLuaBehaviourCaller), KiraraKiraraLuaBehaviourCallerWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Kirara.UIMgr), KiraraUIMgrWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Kirara.UI.Panel.AbstractBasePanel), KiraraUIPanelAbstractBasePanelWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Kirara.UI.Panel.DialogPanel), KiraraUIPanelDialogPanelWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Kirara.LuaUtils.LuaBasePanel), KiraraLuaUtilsLuaBasePanelWrap.__Register);
        ...
        static void wrapInit1(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(Kirara.AttrBuff.AttrBuffSet), KiraraAttrBuffAttrBuffSetWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Kirara.AttrBuff.OnActionStartContext), KiraraAttrBuffOnActionStartContextWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Kirara.AttrBuff.OnAttackHitContext), KiraraAttrBuffOnAttackHitContextWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Tutorial.DerivedClass.TestEnumInner), TutorialDerivedClassTestEnumInnerWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(KiraraDirectBinder.KiraraDirectBinder), KiraraDirectBinderKiraraDirectBinderWrap.__Register);
        ...
        static void Init(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.AddInterfaceBridgeCreator(typeof(Kirara.AttrBuff.IBuffComponent), KiraraAttrBuffIBuffComponentBridge.__Create);
...
namespace XLua
{
	...
	internal partial class InternalGlobals
    {
		...
		delegate DG.Tweening.Tweener __GEN_DELEGATE27( UnityEngine.RectTransform target,  float duration,  float strength,  int vibrato,  float randomness,  bool snapping,  bool fadeOut,  DG.Tweening.ShakeRandomnessMode randomnessMode);
		
		delegate DG.Tweening.Tweener __GEN_DELEGATE28( UnityEngine.RectTransform target,  float duration,  UnityEngine.Vector2 strength,  int vibrato,  float randomness,  bool snapping,  bool fadeOut,  DG.Tweening.ShakeRandomnessMode randomnessMode);
		...
		delegate DG.Tweening.Core.TweenerCore<UnityEngine.Vector2, UnityEngine.Vector2, DG.Tweening.Plugins.CircleOptions> __GEN_DELEGATE41( UnityEngine.RectTransform target,  UnityEngine.Vector2 center,  float endValueDegrees,  float duration,  bool relativeCenter,  bool snapping);
	    ...
	    static InternalGlobals()
		{
		    extensionMethodMap = new Dictionary<Type, IEnumerable<MethodInfo>>()
			{
				...
				{typeof(UnityEngine.RectTransform), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE41(DG.Tweening.DOTweenModuleUI.DOShapeCircle)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
