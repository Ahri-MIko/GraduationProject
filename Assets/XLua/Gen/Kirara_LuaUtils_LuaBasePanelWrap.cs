...
namespace XLua.CSObjectWrap
{
    ...
    public class KiraraLuaUtilsLuaBasePanelWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Kirara.LuaUtils.LuaBasePanel);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Kirara.LuaUtils.LuaBasePanel();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Kirara.LuaUtils.LuaBasePanel constructor!");
        ...
        static int _m_PlayEnter(RealStatePtr L)
        {
		    try {
                ...
                Kirara.LuaUtils.LuaBasePanel gen_to_be_invoked = (Kirara.LuaUtils.LuaBasePanel)translator.FastGetCSObj(L, 1);
