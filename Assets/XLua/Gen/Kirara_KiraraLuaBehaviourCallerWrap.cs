...
namespace XLua.CSObjectWrap
{
    ...
    public class KiraraKiraraLuaBehaviourCallerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Kirara.KiraraLuaBehaviourCaller);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Kirara.KiraraLuaBehaviourCaller();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Kirara.KiraraLuaBehaviourCaller constructor!");
        ...
        static int _g_get_luaScript(RealStatePtr L)
        {
		    try {
                ...
                Kirara.KiraraLuaBehaviourCaller gen_to_be_invoked = (Kirara.KiraraLuaBehaviourCaller)translator.FastGetCSObj(L, 1);
